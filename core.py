...
# ---------- Registries ----------
_TASKS: Dict[str, Callable[[QContext], Any]] = {}
_CHECKS: Dict[str, Callable[[QContext], CheckResult]] = {}
...
class Runner:
    def __init__(self, env: Dict[str, Any], params: Dict[str, Any],
                 workdir: str = ".qtrail", max_workers: int = 8,
    ...
    def run(self, targets: Iterable[str], parallel: bool = False):
        ...
        ctx = QContext(env=self.env, params=self.params, artifacts={}, workdir=self.workdir)
